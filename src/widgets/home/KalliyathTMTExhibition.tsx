...
const exhibitionHighlights = [
  {
    ...
    description:
      "Explore modern techniques used in the production and processing of high-quality structural steel.",
    icon: <Building2 className="w-8 h-8 text-orange-500" />,
  },
  {
    title: "Material Strength",
    description:
      "Understand how steel strength, durability, and performance are evaluated through testing.",
    icon: <Shield className="w-8 h-8 text-blue-500" />,
  },
  {
    title: "Structural Engineering",
    description:
      "Discover how engineering principles are applied to design strong and reliable structures.",
    icon: <Layers className="w-8 h-8 text-cyan-500" />,
  },
  {
    title: "Construction Technology",
    description:
      "Explore modern construction practices and technologies improving structural performance.",
    icon: <Hammer className="w-8 h-8 text-emerald-500" />,
  },
  {
    title: "Sustainable Building",
    description:
      "Learn how efficient material usage and sustainable construction practices can reduce environmental impact.",
    icon: <Leaf className="w-8 h-8 text-purple-500" />,
  },
];

export default function KalliyathTMTExhibition() {
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:max-w-none lg:grid-cols-2 lg:items-center mb-20">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-slate-300">
              An engaging industry showcase focusing on modern structural
              engineering, steel manufacturing techniques, and resilient
              construction practices. Discover material strength, structural
              durability, and sustainable building technologies.
            </p>
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="border-l-2 border-blue-500 pl-6">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Civil Engineering Students • Engineering Students •
                  Architects • Faculty & Researchers • Construction Enthusiasts
                </p>
              </div>
            </div>
          </motion.div>
