...
export interface SplitTextProps {
  ...
  /** ms to wait before starting animation (for hero elements already in viewport) */
  enterDelay?: number;
  /** Use ScrollTrigger instead of a plain timed animation (good for below-fold elements) */
...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  useGSAP(
    () => {
      ...
      const buildScrollTriggerConfig = (triggerEl: HTMLElement) => {
        ...
        return { trigger: triggerEl, start: `top ${startPct}%${sign}`, once: true, fastScrollEnd: true };
      };
      ...
      const splitInstance = new GSAPSplitText(el, {
        ...
        onSplit: (self: GSAPSplitText) => {
          ...
          const tweenVars: gsap.TweenVars = {
            ...
            ease,
            stagger: delay / 1000,
            delay: useScrollTrigger ? 0 : enterDelay / 1000,
            onComplete: () => {
          ...
          if (useScrollTrigger) {
            tweenVars.scrollTrigger = buildScrollTriggerConfig(el);
          }
