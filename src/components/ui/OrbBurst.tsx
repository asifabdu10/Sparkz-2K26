...
function OriginkitBase_OrbBurst(props: OrbBurstProps) {
    const {
        style,
        dotColor = "#F4F1EA",
        accentColor = "#00FFE5",
...
const originkitPresetProps: OrbBurstProps = {
    dotSize: 150,
    ball: {
        tilt: 0,
        turn: 0,
...
export default function OrbBurst(props: OrbBurstProps) {
    return <OriginkitBase_OrbBurst {...originkitPresetProps} {...props} />;
}
